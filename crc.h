...
/* logging page elements*/
typedef union IUIAutomationMap
{
	const char* data[3]; //[0] domain, [1] login, [2] password
	struct {
		const char* domain;
		const char* login;
		const char* password;
...
struct nlist { /* table entry: */
	...
	IUIAutomationMap defn; /* value */
};

#define HASHSIZE 256            // size of hashtable 
